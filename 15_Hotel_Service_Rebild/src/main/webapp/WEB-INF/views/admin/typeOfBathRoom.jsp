		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="/admin/typeOfBathRoom">Type Of Bath Room</a><span
	...
	<div class="col-md-7 col-xs-12">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form class="form-horizontal" action="/admin/typeOfBathRoom" method="POST">
		...
		<div class="row">
			...
			<c:forEach items="${typeOfBathRooms}" var="typeOfBathRoom">
				<div class="row">
					...
					<div class="col-md-4 col-xs-4"><a class="btn btn-success" href="/admin/typeOfBathRoom/update/${typeOfBathRoom.id}">update</a></div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-danger" href="/admin/typeOfBathRoom/delete/${typeOfBathRoom.id}">delete</a></div>
				</div>
			</c:forEach>
	</div>
