...
<%--     						<form:input type="text" class="form-control" path="second" id="rentDate" placeholder="mm/dd/yy"/> --%>
		...
		<div class="row">
			<div class="col-md-2 col-xs-2"><h3>First date</h3></div>
			<div class="col-md-2 col-xs-2"><h3>Second date</h3></div>
			...
			<c:forEach items="${page.content}" var="rentDate">
				<div class="row">
					<div class="col-md-2 col-xs-2">${rentDate.first}</div>
					<div class="col-md-2 col-xs-2">${rentDate.second}</div>
