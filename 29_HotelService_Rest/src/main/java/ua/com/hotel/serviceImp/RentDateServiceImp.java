...
public class RentDateServiceImp implements RentDateService{
	...
	@Override
	public RentDate findFirstByRoomService(LocalDate first, LocalDate second) {
		return rentDateDao.findFirstByRoomService(first, second);
	}

	@Override
	public RentDate findSecondByRoomService(LocalDate first, LocalDate second) {
		return rentDateDao.findSecondByRoomService(first, second);
	}
