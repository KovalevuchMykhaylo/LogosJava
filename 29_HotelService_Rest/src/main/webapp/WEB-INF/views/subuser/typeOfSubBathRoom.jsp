	...
	<div class="col-md-7 col-xs-12">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/subuser/typeOfSubRoom" method="POST" modelAttribute="typeOfBathRoom">
		...
		<div class="row">
			...
			<c:forEach items="${page.content}" var="typeOfBathRoom">
				<div class="row">
					...
					<div class="col-md-4 col-xs-4"><a class="btn btn-success" href="/subuser/typeOfSubRoom/update/${typeOfBathRoom.id}<custom:allParams/>">update</a></div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-danger" href="/subuser/typeOfSubRoom/delete/${typeOfBathRoom.id}<custom:allParams/>">delete</a></div>
				</div>
			</c:forEach>
	</div>
