		...
		<div class="row">
			...
			<c:forEach items="${page.content}" var="rentDate">
				<div class="row">
					...
					<div class="col-md-3 col-xs-3"><a class="btn btn-success" href="/admin/rentDate/update/${rentDate.id}<custom:allParams/>">update</a></div>
					<div class="col-md-3 col-xs-3"><a class="btn btn-danger" href="/admin/rentDate/delete/${rentDate.id}<custom:allParams/>">delete</a></div>
				</div>
			</c:forEach>
	</div>
