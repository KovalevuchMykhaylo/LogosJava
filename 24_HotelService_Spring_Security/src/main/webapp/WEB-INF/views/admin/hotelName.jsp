...
<div class="row">
	<div class="col-md-3 col-xs-12">
		<form:form class="form-horizontal" action="/admin/hotelName" method="GET" modelAttribute="filter">
			<custom:hiddenInputs excludeParams="name, adress, phoneNumber, eMail, cityId, _cityId"/>
		...
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/hotelName" method="POST" modelAttribute="hotelName" enctype="multipart/form-data">
					<custom:hiddenInputs excludeParams="name, adress, city,"/>
					<div class="form-group">
					...
					<div class="form-group">
  					...
  					<div class="form-group">
						<label for="hotelName" style="color:red;text-align:left;" class="col-sm-10 col-sm-offset-2 control-label"><form:errors path="phoneNumber"/></label>
					</div>
  					<div class="form-group">
		...
		<div class="row">
			...
			<c:forEach items="${page.content}" var="hotelName">
				<div class="row">
					...
					<div class="col-md-2 col-xs-2">${hotelName.name}</div>
					...
					<div class="col-md-1 col-xs-1"><a class="btn btn-success" href="/admin/hotelName/update/${hotelName.id}<custom:allParams/>">update</a></div>
					<div class="col-md-1 col-xs-1"><a class="btn btn-danger" href="/admin/hotelName/delete/${hotelName.id}<custom:allParams/>">delete</a></div>
				</div>
			</c:forEach>
	</div>
