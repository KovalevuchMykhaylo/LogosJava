				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="one">
						<ul class="nav navbar-nav">
							<li><a href="/" role="button" title="Main page"><span class="glyphicon glyphicon-home" aria-hidden="true"></span></a></li>
						...
						<ul class="nav navbar-nav navbar-right">
							<li><a href="/registration" title="Are you shure" role="button" >
