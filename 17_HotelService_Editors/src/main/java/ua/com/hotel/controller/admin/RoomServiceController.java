...
public class RoomServiceController {
	...
	public String update(@PathVariable Long id, Model model){
		model.addAttribute("roomService", roomServiceService.findOne(id));
		return show(model);
	}
	...
	@PostMapping
	public String save(@ModelAttribute ("roomService") RoomService roomService) {
