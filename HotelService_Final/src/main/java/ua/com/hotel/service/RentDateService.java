...
public interface RentDateService {
	...
	List <RentDate> findFirstByRoomService(LocalDate first, LocalDate second, Long id);

//	RentDate findSecondByRoomService(LocalDate first, LocalDate second, Long id);
}
