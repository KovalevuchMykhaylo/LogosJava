...
//		test101();
	...
	public static void test5(int min, int max) {
		...
		if (sum1 / 5 > sum / 5)
			System.out.println("MassEffect2");
		else if (sum1 / 5 < sum / 5)
			System.out.println("MassEffect1");
		else {
			System.out.println("MassEffect3");
		}
	...
	public static void test9(int min, int max) {
		...
		for (int i = 0; i < 10; i++) {
			...
			array1[i] = random(min, max);
			array2[i] = Math
					.round(((double) array0[i] / (double) array1[i]) * 100.0) / 100.0;
